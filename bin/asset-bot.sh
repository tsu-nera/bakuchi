...
ASSET_FILE_FROM_BITBANK=${EXECDIR}/data/assets/bitbank.csv
ASSET_FILE_TO_BITBANK=${SAVEDIR}/data/assets/bitbank.csv
...
cp ${ASSET_FILE_FROM_BITBANK} ${ASSET_FILE_TO_BITBANK}
